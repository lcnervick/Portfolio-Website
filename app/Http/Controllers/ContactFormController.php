...
class ContactFormController extends BaseController
{
    ...
    public function processForm(Request $request) {
        ...
        $recaptcha = new ReCaptcha(env('GOOGLE_RECAPTCHA_KEY'));
        $recaptchaResponse = $recaptcha->setExpectedAction('leifnervickcontactform')
        ...
        $response = MailController::sendMail('leif@synapticsoftware.net', 'Website Contact Request', $body);
